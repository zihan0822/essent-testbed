...
# firrtl automatically appends the .sv
harness_prefix_full_path := $(shell pwd)/TestHarness
...
TestHarness.sv:
	cd ../firrtl; sbt 'run -i $(FIR_PATH) -o $(harness_prefix_full_path) -E sverilog -foaf $(harness_annos_full_path)'
